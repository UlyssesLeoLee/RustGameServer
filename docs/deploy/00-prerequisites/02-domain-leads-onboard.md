...
| 版本 | 0.1（占位 + 文档化）|
| 依据 | RGS-QA-001 v0.9 DEC-005 + RGS-PLAN-001 v0.7 §3.4.4 + RGS-WBS-001 v0.2 §2 |
| 状态 | **🟠 5 域 Lead 待具名到位** |
...
2. **RGS-ENV-001 v0.2 §6 签字**：5 域 Lead 各自签 §1-§5 域相关核验
3. **RGS-REV-003 §7.3 签字**：5 域 Lead 各自签 G-CODE-02 + G-CODE-05
4. **RGS-EXEC-001 v0.2 签字**：5 域 Lead 签 §2.4 / §3.4 / §4.4 域相关栏位
