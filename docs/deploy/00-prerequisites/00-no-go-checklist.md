...
| G-CODE-03 | ADR-0052 联审 | 🟠 Open | ADR 审批栏 + 拓扑核验 + 故障注入 + 风险接受 | 架构 + SRE + DBA + Platform | [RGS-EXEC-001 §2](../../00-基准与治理/reviews/RGS-EXEC-001_G-CODE专题突破操作手册_v0.2.md) |
| G-CODE-04 | Q-003 Saga 6 场景 | 🟠 Open / Blocker | Saga/Outbox/补偿 + 6 业务场景验收 | 架构 + DBA + Economy 域 Lead | [RGS-EXEC-001 §3](../../00-基准与治理/reviews/RGS-EXEC-001_G-CODE专题突破操作手册_v0.2.md) |
...
| G-CODE-06 | 工具链 + 开发环境基线 | 🟠 Open | Rust 1.98 实测 + PG 18.4 + K3s + 锁定 CI | Platform + DBA + SRE | [RGS-ENV-001 v0.2](../../00-基准与治理/reviews/RGS-ENV-001_环境核验记录模板_v0.2.md) |
...
|---|---|---|---|
| 1 | DBA Lead | ⏳ 所有者背书 | 待具名 |
| 2 | SRE Lead | ⏳ 所有者背书 | 待具名 |
| 3 | Player 域 Lead | ⏳ 所有者背书 | 待具名 |
| 4 | Economy 域 Lead | ⏳ 所有者背书 | 待具名 |
| 5 | Match 域 Lead | ⏳ 所有者背书 | 待具名 |
| 6 | Social 域 Lead | ⏳ 所有者背书 | 待具名 |
| 7 | Admin 域 Lead | ⏳ 所有者背书 | 待具名 |
| 8 | 架构师 | ✅ **Ulysses 实际签 2026-08-21** | — |
| 9 | Q-003 二次 | ⏳ 所有者背书 | 待具名 |
| 10 | Platform Engineer | ⏳ 所有者背书 | 待具名 |
| 11 | QA Lead | ⏳ 所有者背书 | 待具名 |
