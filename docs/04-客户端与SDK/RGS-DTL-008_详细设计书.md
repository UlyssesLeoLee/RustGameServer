...
| 0.3 | 2026-08-25 | 架构师（Ulysses（一人公司 12 角色 per DEC-008）） | — | 同步父 BAS-008 升版至 v0.3 + 补追溯性表到 RGS-BAS-008§11 NFR-SDK / AC-SDK-001〜004 行；本 DTL 主体内容（§2 零拷贝 trait / §3 FFI C ABI / §4 SessionHandshake 字段编号 / §5 bench 骨架）于 v0.1 制定日（2026-08-17）即与 BAS-008 v0.3 同日，BAS-008 v0.3 新增的 §3.1 编解码性能设计在 v0.1 中已落实为 §2 零拷贝 trait 与 §5 基准测试骨架，§11 追溯性表在 v0.1 中已映射 NFR-SDK-001〜005 与 AC-SDK-001〜004，本次升版只同步元数据版本号与修订历史，不引入新设计 | 元数据 / §11 追溯性表 |
