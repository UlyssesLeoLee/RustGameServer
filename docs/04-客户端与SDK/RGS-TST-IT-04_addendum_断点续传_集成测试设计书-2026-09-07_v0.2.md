...
| **0.2** | 2026-09-07 | 架构师（Mavis 接手代签 per DEC-008） | 8 维度增量升版：① 8 域扩展（per 9/6 [游戏A]兼容）② 9 域 mTLS 业务级断点续传（per 9/6 d270ab9 11 步 v3 + d15a0bb 3 NEW 域 k8s yaml）③ 派生约束守护 L15-L23（per 9/6 6c6839e cutover） |
