...
| 0.3 | 2026-08-26 | 架构师（Ulysses（一人公司 12 角色 per DEC-008））| **2026-08-26 当日 25 份 DTL 升版 + 1 份 DTL-036 双 hotfix → 26 份 SPEC v0.1→v0.2 同步调整**：001/002/003/004/005/006/007/008/009/011/012/013/014/015/016/017/018/019/020/021/022/023/024/031/036/038 各加 §A v0.2 对齐说明段;**不引入新设计**——仅落实/复核源 DTL 既有升版内容,正文本 §1~§8 不重写;**不可代签**——审批栏姓名字段仍 = "—",由 Ulysses 在字段级 DD Review 后补签;**缺标比错标更安全**(per DTL-036 v1.4.1 hotfix 复盘修式) |
