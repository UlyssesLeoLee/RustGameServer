...
| 0.2 | 2026-08-25 | 架构师（Mavis 接手 agent per DEC-008）| — | 同步父 BAS-004 升版至 v0.2 + 补追溯性表 AC-LOG-001〜005 验收标准与本文档章节的映射（BAS-004 v0.2 §12 追溯性表新增的 AC 条目此前未在本文档追溯性表中体现，本次仅追加映射行，不改既有章节内容） | 追溯性 |
