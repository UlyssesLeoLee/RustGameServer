# RGS-PM-005 工数管理（Effort）

| 项目 | 内容 |
|---|---|
| 文档编号 | RGS-PM-005 |
| 版本 | 0.1（占位，per 150 工程审计缺失项补全）|
| 依据 | RGS-WF-001 v0.5 §2 150 工程 141 |
...
本文件是 RGS-WF-001 v0.5 §2 150 工程审计中**缺失 RGS 引用**的 PM（工数管理）工程的占位文档。

**补全范围**：覆盖 150 工程编号 141。

**特别说明**（per DEC-008）：Effort tracking：人·天 + token/周（per RGS-TS-001 v0.6 §6.2 OLU 双轨制）。
