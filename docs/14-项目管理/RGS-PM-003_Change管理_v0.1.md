# RGS-PM-003 Change管理（Change）

| 项目 | 内容 |
|---|---|
| 文档编号 | RGS-PM-003 |
| 版本 | 0.1（占位，per 150 工程审计缺失项补全）|
| 依据 | RGS-WF-001 v0.5 §2 150 工程 120 / 136 |
...
本文件是 RGS-WF-001 v0.5 §2 150 工程审计中**缺失 RGS 引用**的 PM（Change管理）工程的占位文档。

**补全范围**：覆盖 150 工程编号 120 / 136。

**特别说明**（per DEC-008）：CR（Change Request）流程：申请 → 评审 → 批准 → 实施 → 验证；一人公司 = 自我申请 + 自我批准 + 流程化校验。
