# RGS-RACI-ECONOMY-V1 经济域 Lead 责任矩阵 v1.0（Economy Domain Lead RACI v1.0）

**RGS-RACI-ECONOMY-V1**

| 项目 | 内容 |
|---|---|
| 文档编号 | RGS-RACI-ECONOMY-V1 |
...
| 适用范围 | economy 域（货币 / 道具 / 账本 / 限购 / Saga 跨域资产 / 资金相关决策 / Reward 不可逆事件） |
...
| 治理角色（行） | 7 | 经济域 Lead / 架构师 / SRE / DBA / 安全 / shared-platform / saga 召集人 |
...
| 任务 \ 角色 | 经济域 Lead | 架构师 | SRE | DBA | 安全 | shared-platform | saga 召集人 |
|---|---|---|---|---|---|---|---|
| 1. 货币扣减（balance_dec） | **A** | C | I | C | C | I | I |
| 2. 道具发放（item_grant） | **A** | I | I |
| 3. 账本平衡（ledger_imbalance） | **A** | C | I | C | C | I | I |
| 4. 限购规则（purchase_limit） | **A** | C | I | C |
...
| 治理角色 | 真实责任人 | 兼任关系 |
|---|---|---|
| 经济域 Lead | Ulysses | 兼架构师 / Saga 召集人（per DEC-008 一人公司 12 角色治理基线） |
...
| 域 Lead | 签字 | 日期 | 备注 |
|---|---|---|---|
| 经济域 Lead（Ulysses per DEC-008）| _待 DDD Review 阶段补签_ | — | per RGS-SPEC-CROSS-011 DDD Review 模板 §3 字段级核对 |
