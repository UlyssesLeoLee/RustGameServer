# RGS-PM-006 成本管理（Cost）

| 项目 | 内容 |
|---|---|
| 文档编号 | RGS-PM-006 |
| 版本 | 0.1（占位，per 150 工程审计缺失项补全）|
| 依据 | RGS-WF-001 v0.5 §2 150 工程 142 |
...
本文件是 RGS-WF-001 v0.5 §2 150 工程审计中**缺失 RGS 引用**的 PM（成本管理）工程的占位文档。

**补全范围**：覆盖 150 工程编号 142。

**特别说明**（per DEC-008）：Cost tracking：基础设施 + 工具链 + 第三方服务月度成本；一人公司 = 现金流监控。
