...
| 关联决策 | DEC-001、DEC-002、DEC-003、DEC-004（RGS-QA-001 v0.5） |
| 涉及文档 | RGS-REQ-031、RGS-BAS-031、RGS-DTL-031、RGS-TS-001、RGS-QA-001 |

> **状态说明**：本文记录 DEC-001〜004 的用户选择和候选实施规则。具名人类审批、目标拓扑验证及故障注入证据齐备前，本文不得作为生产基线或运行指标承诺；量化口径以 RGS-QA-001 v0.5 §0 的待验证规划假设为准。
