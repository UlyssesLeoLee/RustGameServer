...
> **v0.6 修订**：first slice 窗口 8-12 周 → **14-18 周**（per RGS-QA-001 v0.11 DEC-006；用户决策 2026-08-21）。**DEC-004 范围不变**（5 域全开 + 完整 ARC-018/021/042），**仅时间窗口修订**（5 域独立 Lead 配置后，OLU 必突破 NFR-OP-010；路径 B = 调低 OLU 期望 = 拉长窗口）。
