...
| **0.2.1 (升版)** | **2026-09-07** | **架构师（Mavis 接手代签 per DEC-008）** | **8 维度增量升版**：① 9/5 plugin 集群架构（per 61cf306 / f785f18 / 5cfd692）② AI Function Pool (per RGS-INC-001 v0.2 §15) ③ 8 域扩展（per 9/6 [游戏A]兼容）④ 9 域 mTLS 业务级（per 9/6 d270ab9）⑤ 派生约束守护 L15-L23（per 9/6 6c6839e cutover） |
