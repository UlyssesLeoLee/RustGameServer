...
| 配套文档 | 19 份 ADR（RGS-ADR-0001～0054）、RGS-OPS-001 部署运维说明、RGS-IMPL-001 实施约定、各域 BAS/DTL、RGS-QA-001 v0.9、RGS-PLAN-001 v0.7 |
| 制定日 | 2026-08-19 |
| 最终更新日 | 2026-08-21 |
| 制定者 | 架构师 |
...
>
> **配套文档**：校准执行用 [RGS-ENV-CALIB-001](../00-基准与治理/reviews/RGS-ENV-CALIB-001_OLU校准记录模板_v0.1.md) 模板；WBS 任务分解（5 域 Lead L4 任务清单）用 [RGS-WBS-001](../12-工作流/RGS-WBS-001_5层工作分解结构_v0.2.md)
