...
>
> **不兼任原则（DEC-005 核心）**：架构师不兼任 player 域 Lead；SRE 不兼任 admin 域 Lead。Q-003 跨域核心问题需 Economy 域 Lead 独立决策权；COC 控制面属 admin 域独立控制面，SRE 兼任会与 admin 域 Lead 责任重叠。**5 域独立 Lead 必然突破 NFR-OP-010（2 SRE ≤ 20 人·天/周）的人天预算，详见 RGS-QA-001 v0.13 §9.5 OLU 决策影响**。
...
| Q-015 | OLU 重新核算（含 5 域独立 Lead 编制）| PH-0/每周 | **v0.5 DEC-005 影响**：5 域独立 Lead 必突破 NFR-OP-010（2 SRE ≤ 20 人·天/周）；**任一阶段估算 > 22 人·天/周即升级风险**，PM + SRE Lead 须从"扩 SRE 编制"或"调低 OLU 期望"中二选一；详见 RGS-QA-001 v0.13 §9.4 OLU 决策影响 |
