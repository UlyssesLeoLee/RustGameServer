...
> **核心约束**：
> - **L1 阶段**：8 PH（per RGS-PLAN-001 v0.6 §3.1 14-18 周重排）
...
## §1 L1 阶段（8 PH，per RGS-PLAN-001 v0.6 §3.1）
...
> **本 WBS 与 RGS-PLAN-001 v0.6 §3.1 PH 表 / RGS-TS-001 v0.6 §6.2 双轨制 / RGS-ENV-CALIB-001 校准模板 三方一致**。
