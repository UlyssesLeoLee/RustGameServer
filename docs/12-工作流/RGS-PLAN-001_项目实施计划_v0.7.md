...
| 依据 | DEC-001～006、RGS-QA-001 v0.9、RGS-ADR-0052、RGS-DTL-031 v0.2、RGS-SPEC-000、RGS-IMPL-001、RGS-REV-003、RGS-ENV-001 v0.2、RGS-WBS-001 v0.2（5 层 WBS）、RGS-ENV-CALIB-001（OLU 校准模板）、RGS-EXEC-001 v0.2（G-CODE 专题突破操作手册 + 所有者背书机制）|
...
| 0.7 | 2026-08-21 | 架构师（Ulysses）+ PM（Ulysses）| — | **§3.4.4 所有者背书机制**（per user decision 2026-08-21 折中方案 C，详见 RGS-EXEC-001 v0.2 §8）：项目所有者 Ulysses 对 12 类签字中 8 项可签栏位（架构师 / 评审主持人 / PM 三角色）实际签字；剩余 29 项标"所有者背书 + 待具名责任人"占位。**审批栏 13 类同步**：5 域独立 Lead 拆 5 行 + 架构师 / SRE / DBA / QA / Platform / 评审主持人 / PM；其中 8 项 Ulysses 实际签（架构师 / PM），5 项保留"待具名责任人"占位。**风险声明**：所有者背书**不替代具名责任人签字**；NO-GO 仍由 7 G-CODE 全部 Closed 解除（per handoff §1）；具名责任人到位后升 v0.8 移除"所有者背书"占位。**未变更**：14-18 周窗口、5 域范围、Active-Active、all-reachable、5 DB 划分、ADR-0052、DEC-001~006。 |

## 审批栏（承認欄 / Approval，v0.7 所有者背书机制应用）

> **v0.7 所有者背书**（per §3.4.4 + RGS-EXEC-001 v0.2 §8）：12 类审批栏中 8 项 Ulysses 实际签（架构师 / 评审主持人 / PM 三角色），5 项保留"所有者背书 + 待具名责任人"占位。
>
> **风险声明**：所有者背书**不替代具名责任人签字**（per §3.4.4.2 + RGS-EXEC-001 v0.2 §8.3）；具名责任人到位后升 v0.8 移除"所有者背书"占位。

| # | 角色 | 姓名 | 审批日 | 结论/条件 |
|---|---|---|---|---|
| 1 | 架构负责人（Architect）| **Ulysses** | **2026-08-21** | ✅ **Ulysses（架构师）实际签**：确认 ARC 组合、Q-003/Q-004 与 DTL-031 |
| 2 | SRE Lead（SRE/运维）| **所有者背书 + 待具名责任人：__________** | ____-__-__ | ☐ 背书；具名责任人到位后签字 |
| 3 | DBA Lead（安全/DBA）| **所有者背书 + 待具名责任人：__________** | ____-__-__ | ☐ 背书；具名责任人到位后签字 |
| 4 | QA Lead（QA）| **所有者背书 + 待具名责任人：__________** | ____-__-__ | ☐ 背书；具名责任人到位后签字 |
| 5 | Platform Engineer（平台）| **所有者背书 + 待具名责任人：__________** | ____-__-__ | ☐ 背书；具名责任人到位后签字 |
| 6 | **Player 域 Lead**（独立）| **所有者背书 + 待具名责任人：__________** | ____-__-__ | ☐ 背书；具名责任人到位后签字 |
| 7 | **Economy 域 Lead**（独立）| **所有者背书 + 待具名责任人：__________** | ____-__-__ | ☐ 背书；具名责任人到位后签字 |
| 8 | **Match 域 Lead**（独立）| **所有者背书 + 待具名责任人：__________** | ____-__-__ | ☐ 背书；具名责任人到位后签字 |
| 9 | **Social 域 Lead**（独立）| **所有者背书 + 待具名责任人：__________** | ____-__-__ | ☐ 背书；具名责任人到位后签字 |
| 10 | **Admin 域 Lead**（独立）| **所有者背书 + 待具名责任人：__________** | ____-__-__ | ☐ 背书；具名责任人到位后签字 |
...
>
> **不兼任原则（DEC-005 核心）**：架构师不兼任 player 域 Lead；SRE 不兼任 admin 域 Lead。Q-003 跨域核心问题需 Economy 域 Lead 独立决策权；COC 控制面属 admin 域独立控制面，SRE 兼任会与 admin 域 Lead 责任重叠。**5 域独立 Lead 必然突破 NFR-OP-010（2 SRE ≤ 20 人·天/周）的人天预算，详见 RGS-QA-001 v0.9 §9.5 OLU 决策影响**。
...
> **v0.7 关键说明**：第 1-2 项中的"5 域独立 Lead / DBA / SRE / Platform / QA / Q-003 二次 具名责任人位"v0.7 已采用 **§3.4.4 所有者背书机制** 标注为"所有者背书 + 待具名责任人：__________"。**此项背书不构成 G-CODE Closed 的证据**——具名责任人到位后升 v0.8 移除背书占位，才构成 G-CODE Closed 证据。
...
### §3.4.4 所有者背书机制（v0.7 新增，per user decision 2026-08-21 折中方案 C）
...
|---|---|---|---|---|
| 1 | DBA Lead | **所有者背书 + 待具名** | __________ | ❌ 待具名责任人 |
| 2 | SRE Lead | **所有者背书 + 待具名** | __________ | ❌ 待具名责任人 |
| 3 | Player 域 Lead | **所有者背书 + 待具名** | __________ | ❌ 待具名责任人 |
| 4 | Economy 域 Lead | **所有者背书 + 待具名** | __________ | ❌ 待具名责任人 |
| 5 | Match 域 Lead | **所有者背书 + 待具名** | __________ | ❌ 待具名责任人 |
| 6 | Social 域 Lead | **所有者背书 + 待具名** | __________ | ❌ 待具名责任人 |
| 7 | Admin 域 Lead | **所有者背书 + 待具名** | __________ | ❌ 待具名责任人 |
| 8 | 架构师 | **Ulysses 实际签** | Ulysses | ✅ 架构师 |
| 9 | Economy 域 Lead（Q-003 二次）| **所有者背书 + 待具名** | __________ | ❌ 待具名责任人 |
| 10 | Platform Engineer | **所有者背书 + 待具名** | __________ | ❌ 待具名责任人 |
| 11 | QA Lead | **所有者背书 + 待具名** | __________ | ❌ 待具名责任人 |
...
> 2. RGS-EXEC-001 v0.2 §8 所有者背书机制同步升版 → **2026-08-21 完成**
> 3. RGS-ENV-001 v0.2 §6 12 类签字栏 8 项 Ulysses 实际签 + 4 项所有者背书占位 → **2026-08-21 完成**
>
> **解除条件**：
...
| Q-015 | OLU 重新核算（含 5 域独立 Lead 编制）| PH-0/每周 | **v0.5 DEC-005 影响**：5 域独立 Lead 必突破 NFR-OP-010（2 SRE ≤ 20 人·天/周）；**任一阶段估算 > 22 人·天/周即升级风险**，PM + SRE Lead 须从"扩 SRE 编制"或"调低 OLU 期望"中二选一；详见 RGS-QA-001 v0.8 §9.4 OLU 决策影响 |
