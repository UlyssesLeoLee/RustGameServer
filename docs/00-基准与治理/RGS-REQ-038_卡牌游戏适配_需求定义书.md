...
- **TCG / CCG** (Trading Card Game / Collectible Card Game, 例: [游戏E] / [游戏F]_arena / [游戏G] / [游戏H])
- **休闲卡牌** (例: [通用棋牌] / [通用棋牌] / [游戏J] / [游戏I])
- **集换式卡牌** (例: [游戏K] / [游戏L], 强调卡牌收藏与交易)
...
**Out-of-Scope (本次不适配)**:
- 具体游戏规则引擎 ([游戏E] / [游戏F] / [游戏G] 等具体卡牌效果执行) — 留给各游戏方在 game-logic 业务层实现
- 客户端 UI / 美术 / 音频
- 卡牌数值平衡 / 抽卡概率
- 运营活动 / 赛季 / 通行证
...
| 实时性 | turn-based, 秒级响应 | turn-based / 实时 ([游戏J]) | turn-based |
