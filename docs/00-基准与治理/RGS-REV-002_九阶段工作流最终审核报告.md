...
| 2. 要件定義 | UR/BR/SR/FR/NFR、数据、IF、安全、运维、迁移、验收标准 | RGS-REQ-001～035、RGS-REQ-004、RGS-QA-001 v0.12、RGS-IMPL-001 | 🟡 RD Review、Q-003 等具名 Gate 待闭环 |
...
|---|---|---|---|
| 🔴 | 具名审批 RGS-QA-001 v0.12，至少闭合 Q-003/Q-025 等 Gate 证据；DEC-005 5 域独立 Lead + DEC-006 路径 B（14-18 周）已选 | 签字记录、决策版本和责任人 | QA Gate 可审计 |
...
关联导航：[RGS-WF-001 系统工程工作流](../12-工作流/RGS-WF-001_系统工程工作流_v0.5.md)、[RGS-PLAN-001 项目实施计划 v0.8](../12-工作流/RGS-PLAN-001_项目实施计划_v0.8.md)、[RGS-QA-001 实施前 QA 表 v0.10](../11-实施QA/RGS-QA-001_实施前QA表_v0.12.md)、[RGS-IMPL-001 实施约定](../13-实现规格/RGS-IMPL-001_实施约定与工程边界.md)。
