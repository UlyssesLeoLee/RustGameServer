-- economy-service migration 0003_outbox（per RGS-REV-007 CH1+AH1 / DEC-015 P1 / WF-1-55.17）
-- 注：经济域已有 0002_saga_init.sql（per WF-1-55.1），本迁移用 0003 续号
