//! economy-service Service trait 定义
//!
...
/// economy-service 域 Service trait
#[async_trait]
pub trait EconomyService: Send + Sync {
    ...
    async fn ping(&self) -> Result<String> {
        Ok("economy-service pong".to_string())
    }
}

/// economy-service 域默认 Service 实现（54.1 占位）
...
impl Default for EconomyServiceImpl {
    fn default() -> Self {
        Self::new()
    }
}
