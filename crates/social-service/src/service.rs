//! social-service Service trait 定义
//!
...
/// social-service 域 Service trait
#[async_trait]
pub trait SocialService: Send + Sync {
    ...
    async fn ping(&self) -> Result<String> {
        Ok("social-service pong".to_string())
    }
}

/// social-service 域默认 Service 实现（54.1 占位）
...
impl Default for SocialServiceImpl {
    fn default() -> Self {
        Self::new()
    }
}
